...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {
        pathname !== "/dashboard/categories/photo-album" && 
        pathname !== "/dashboard/categories/gifts" && 
        pathname !== "/dashboard/categories/calendars" ? 
        <DashboardSidebar /> : <></>
      }
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className={`flex-1 overflow-x-hidden overflow-y-auto bg-[#F4F8F2] ${
          pathname === "/dashboard/categories/photo-album" || pathname === "/dashboard/categories/gifts" || pathname === "/dashboard/categories/calendars"
          ? "" : "p-4 sm:p-6"} `}>
