...
export default function MiddleSide({ uploadedImages, handleImageUpload }) {
  ...
  return (
    <div className='w-[300px] bg-white p-6 h-screen sticky top-0 border-l-[1px] border-[#98989833]'>
      <div>
